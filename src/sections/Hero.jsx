...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-96px)] flex items-center bg-[var(--bg-primary)] ">
      <img
        src={heroImg}
        alt="Perfume Hero"
        className="absolute top-0 left-0 w-full h-full object-cover object-center md:object-right brightness-90"
      />
